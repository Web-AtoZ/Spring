...
public class HelloController extends BaseController {
  ...
  /**
   * 예시호출 GET 127.0.0.1:8080/annotation?name=&numList=1,2,3,4 Body { "address": "test address",
   * "inner": { "test" : "test", "test2" : "test2", "test3" : "test3" } }
   */
  @GetMapping("/annotation")
  public TestDomain annotaionTest(
      @Valid TestDomain testDomain, @RequestBody TestBodyDomain testBodyDomain) {
    System.out.println("===========================");
