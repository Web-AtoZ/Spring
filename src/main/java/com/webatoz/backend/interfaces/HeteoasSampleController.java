...
//
//    Link selfLink =
// linkTo(methodOn(HeteoasSampleController.class).getData(hateoasId)).withSelfRel();
//
//    Link listLink =
// linkTo(methodOn(HeteoasSampleController.class).listData()).withRel("list-test");
//
//    Link createLink =
//        linkTo(methodOn(HeteoasSampleController.class).createData(new
// Test())).withRel("create-test");
//
//    Link updateLink =
